...
<div class="index-container">
        ...
        ?>
         <div class="personal-title">View Post</div>
               ...
               <h1>Comment</h1>    
                ...
                <div class="comment-header">
                    <div class="comment-header-img"><img src="<?php echo $cpics; ?>" alt="..."/></div>       
                        ...
                        { 
                        ?>
                        <div><a href="del_comment.php?comment_id=<?php echo $ccccc;?>&post_id=<?php echo $get_id; ?>"><i class="fa fa-trash-o">Delete</i></a></div>
                        <?php 
                        } 
                        else   
                        {} 
            ...
            <div class="comment-header">
                <div class="comment-header-img"><img src="<?php echo $rpics;?>" alt="..."/></div>       
                    ...
                    { 
                    ?>
                        <div><a href="delete_reply.php?repz_id=<?php echo $repz_id;?>&post_id=<?php echo $get_id; ?>"><i class="fa fa-trash-o"></i></a></div>
                    <?php  
                    }
                    else   
                    {} 
            ...
            <div class="comment-body">   
                    ...
                    <?php } ?>   
                                ...
                                <div><input type="hidden" name="post_id" value="<?php echo $get_id; ?>" /></div>
                                <div><input type="hidden" name="comment_id" value="<?php echo $ccomment_row['comment_id'];; ?>" /></div>
                ...
                <div><input type="hidden" name="topic" value="<?php echo $ttttt; ?>" /></div>
                <div><input type="hidden" name="post_id" value="<?php echo $get_id; ?>" /></div>
				<div class="comment-body-inputs">
