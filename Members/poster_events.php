  ...
  document.querySelector("video").src = blobURL;
    ...
    <?php
      if (isset($_POST['post'])){
        ...
        $connect->query("insert into post (member_id,date_posted,post_content,post_title,post_image,topic,access,pstatus_rnt) values('$id2','$date_posted','$post_content','$post_title','$location','$topic','Member','PENDING')");
        if($topic=="FEED")
        {
