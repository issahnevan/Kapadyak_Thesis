...
<li class="nav-item">
                ...
                <span class="link-text">Manage Member</span>
                      ...
                      <!-- Manage Member -->
<li class="nav-item">
                <a href="feed_tip.php" class="nav-link highlight ">
                <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-person-workspace" viewBox="0 0 16 16">
                <g class="fa-group">
                    <path
                        fill="currentColor"
  ...
  <a href="post_tip.php">Add Post</a>
            ...
            <li> <a href="delete_post.php<?php echo '?id='.$ppppp; ?>"><i class="fa fa-trash-o"></i> Delete</a> </li>
                                ...
                                <table><tr><td width="800">
                                 ...
                                 <table border="0" width="800">
                                  ...
                                  <tr><td width="500">  
                                   <a href="add_views.php?id=<?php echo $ppppp ?>"><b>View Topic</b></a> | <b>Threads</b> ( <font color="red" size="4"><?php echo $post_row['threads'] ;?></font> ) | <b>Views</b> ( <font color="orange" size="4"><?php  echo $post_row['views']; ?></font> )</td>
                                  </tr>
