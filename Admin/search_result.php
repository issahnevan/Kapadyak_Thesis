...
<font size="5"> Search Result for:  <?php echo $search=$_POST['search']; ?></font>
 ...
 &nbsp;
		...
		$query = $conn->query("select * from members where first_name like '%$search%' or last_name like '%$search%' or middle_name like '%$search%' or email_address like '%$search%' or address like '%$search%' or username like '%$search%' or access like '%$search%'");
