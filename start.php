    ...
    <div class="start-content">
        <section class="page-one">
            <div class="page-one-left">
                <div class="page-one-logo">
                <img src="Images/logo.png" class="login-logo2">
                <div class="login-title">APADYAK</div>
                </div>
                <div class="page-one-title">A PLACE WHERE CYCLIST ENTHUSIASTS CONNECT</div>
        ...
        <section class="page-four">
            <div class="page-four-content">
                <div class="page-four-title">
                    Ride with us, Enthusiast.
                </div>
                <div class="page-four-subtitle">
                    Discover the platform that gives you a way to connect with other cyclist.
                </div>
                <button class="join-button">
                <a href="user_register.php">GET STARTED </a>
                </button>
            </div>
        </section>
    </div>
